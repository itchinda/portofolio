...
# Compute the correlation of all variables with each other
corr_matrix = df_merged.corr()

# Isolate specifically the correlations with respect to our target variable
...
# The cmap='coolwarm' parameter helps contrast positive (red) and negative (blue) correlations well
sns.heatmap(corr_matrix, annot=True, fmt=".2f", cmap="coolwarm", vmin=-1, vmax=1, square=True)
plt.title("Correlation Matrix of Graham Building Variables")
plt.tight_layout()
plt.show()
```
